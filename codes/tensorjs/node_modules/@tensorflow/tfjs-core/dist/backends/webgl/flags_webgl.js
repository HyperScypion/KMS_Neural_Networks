...
environment_1.ENV.registerFlag('WEBGL_FORCE_F16_TEXTURES', function () { return false; });
...
environment_1.ENV.registerFlag('WEBGL_PACK_UNARY_OPERATIONS', function () { return environment_1.ENV.getBool('WEBGL_PACK'); });
 ...
 */
environment_1.ENV.registerFlag('WEBGL_RENDER_FLOAT32_CAPABLE', function () { return webgl_util.isCapableOfRenderingToFloatTexture(environment_1.ENV.getNumber('WEBGL_VERSION')); });
/**
 * Whether rendering to float32 textures is enabled. If disabled, renders to
 * float16 textures.
 */
environment_1.ENV.registerFlag('WEBGL_RENDER_FLOAT32_ENABLED', function () {
    return environment_1.ENV.getBool('WEBGL_FORCE_F16_TEXTURES') ?
        false :
        environment_1.ENV.getBool('WEBGL_RENDER_FLOAT32_CAPABLE');
});
/**
